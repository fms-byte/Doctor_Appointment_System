...
<body>
    ...
    <div class="container mx-auto py-8 mb-8 mt-20">
        <div class="mx-auto bg-white bg-opacity-90 p-4 border border-gray-300 rounded shadow-md" style="width: 30%;">
            <h2 class="text-2xl font-bold mb-4">Login as Doctor</h2>
            <form action="process.php" method="POST">
                ...
                <div class="flex justify-center">
                    <button type="submit" name="doctor_login" class="bg-gray-500 text-white px-4 py-2 rounded-md hover:bg-gray-600">Login</button>
                </div>
            </form>
        </div>
    </div>
