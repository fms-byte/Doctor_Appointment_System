        ...
        <div class="mx-auto bg-white bg-opacity-90 p-4  border border-gray-300 rounded shadow-md" style="width: 70%;">
            ...
            <form action="process.php" method="POST" name="doctor_register">
                <div class="mb-4">
                    ...
                    <input type="text" name="name" id="name" class="w-full py-1 pl-2 border-2 border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500">
                </div>
                <div class="mb-4">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="specialization" id="specialization" class="w-full py-1 pl-2 border-2 border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500">
                </div>
                <div class="mb-4">
                ...
                <div class="mb-4">
                    ...
                    <input type="time" name="start" id="start" class="w-full py-1 pl-2 border-2 border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500">
                </div>
                <div class="mb-4">
                    <label for="end" class="block text-gray-700">End</label>
                    <input type="time" name="end" id="end" class="w-full py-1 pl-2 border-2 border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500">
                </div>
